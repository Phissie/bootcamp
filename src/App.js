    ...
    <div>
      <div className="App">
        <div className="heading">
          <p>Hello World! I'm a Full-Stack Developer based in London</p>
        </div>
      ...
      <p className="About-Me">
        <h2>
          ...
          I’m a Full-Stack Developer based in West London. I am passionate about
          ...
          it’s functionality. I started learning to Ruby in my free time in
          Winter 2018 after completing a five week course with Google Digital
          garage that introduced me to Javascript and CSS. In January 2020, I
          became a full time developer learning Full Stack web development,
          ReatcJS, Javascript and CSS. When I am not working on my personal
          projects, I can be found around London attending tech Meetup groups
          and conferences; Ruby Hacknight London, ReactJs Girls, CodeBar London,
          IBM Code London. Code Mesh
        </h2>
      </p>
    </div>
  );
